...
public class S3ParamsExtractorTest {
    ...
    @Test
    public void testCredentialsAtUserInfo() throws IOException {
    ...
    @Test
    public void testCredentialsAtQuery() throws IOException {
        URL url = new URL("s3://bucket.endpoint/key?accessKey=accessKey&secretKey=secretKey");
